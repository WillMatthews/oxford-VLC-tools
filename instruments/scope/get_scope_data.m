...
%GET_SCOPE_DATA takes an 'oscilloscope' structure (generated by a 'get_xx_scope' file) and a settings structure, returned by a 'get_xx_scope' file)
% returns a 'data out' structure containing everything returned by the oscilloscope
