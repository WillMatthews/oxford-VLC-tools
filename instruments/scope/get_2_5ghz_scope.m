function [scopeOut, set] = get_2_5ghz_scope(set)
%GET_XX_SCOPE Initialises and connects to an oscilloscope
% requires a "settings structure" set generated by get_scope_set.m
% returns scopeOut (scope visa addr, name, and more in a structure) and updated settings
