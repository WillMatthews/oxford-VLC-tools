function [] = set_keithly196(varargin)
%GET_KEITHLY195 Sets up a from Keithly 196


%% Instrument Connection

% Find a GPIB object.
obj1 = instrfind('Type', 'gpib', 'BoardIndex', 0, 'PrimaryAddress', 7, 'Tag', '');
